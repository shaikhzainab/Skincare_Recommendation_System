# -*- coding: utf-8 -*-
"""
Created on Tue Mar  7 15:23:08 2023
...
df = pd.read_csv('C:/Users/shaikh zainab/Desktop/skincare_new/apps/skindataall.csv', index_col=[0])
...
def sample_recommendation_user(user_id, model=mf_model, interactions=interaction_matrix, user_dict=user_dict,item_dict=product_dict, threshold=4, nrec_items=10, show=True):
    try:
